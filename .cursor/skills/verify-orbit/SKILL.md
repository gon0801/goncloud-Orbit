...
## Alcance comprobado automaticamente

Quality CI ejecuta el pase completo sobre Postgres desechable y Chrome en Linux.
Una captura fallida hace fallar el pase. Los tests de regresion ejecutan los drives
contra el dashboard y Postgres reales; simulan solo transporte HTTP o fallos de Chrome.

El baseline tiene una campana y dos decisiones: comprueba el indicador de orden y
la primera pagina, pero NO demuestra orden relativo ni navegacion a una segunda
pagina. Esas comprobaciones necesitan ampliar la semilla; no se reportan como verificadas.
