...
Campanas lista cada campana con metricas 30d (cost, revenue, clicks, ACoS), el target efectivo y el peldaño de procedencia (cinco: goal_campana, goal_plataforma, setting_plataforma, cache_estado, default). Cada fila lleva su moneda. No hay total al pie.
...
- `campanas-api` el JSON `GET /api/dashboard/campanas` es la misma lista.
