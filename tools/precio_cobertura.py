...
de Orbit y muestra al lado la cuenta del puente (`listing`), avisando si
difieren mas del 5 %. Cero Amazon, cero escritura.
"""
...
def main(argv=None) -> int:
    ...
    try:
        ...
        puente = contar_puente(conn, platform=args.platform)
