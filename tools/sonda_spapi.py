...
# BuyerName, BuyerPhoneNumber, BuyerInfo, BuyerTaxInfo y el buyer de
# 2026-01-01; recipient es quien recibe el pedido (PII en orders). La
# direccion viaja en ShippingAddress. Los fragmentos de direccion solo se
# filtran en orders (en otras fuentes podrian ser ubicacion, no PII).
