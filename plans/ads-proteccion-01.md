...
## Residuales no bloqueantes consignados (revision IA + opus; van a fila al cierre H7)

| ID | Fuente | Contenido | Estado |
| --- | --- | --- | --- |
| R-C3-1 | `C.3/review-c3-opus.md:19-21` obs 1 | Camino de EXITO del merge pre-sello sin test; mutante dedupe `cycle.py:1182` sobrevive (177 passed); arreglo: repro de exito como test + `cycle.py:2106` | TODO; decide el operador |
| R-C4-1 | `C.4/review-c4-rb3-opus.md:24` | #342 mergeado con AI review in_progress y CodeRabbit PENDING; bateria completa verde despues (run 36104837829, 3394 passed): orden de proceso invertido | TODO; decide el operador |
| R-H5-1 | `H5/review-opus-r2.md:162-168` obs 9 | R1 obs 1 y 4-10 abiertas (pesan obs-4: conteo `applied_at` no ve bids, sumar `apply_attempt`; obs-7: digest antes/despues); obs-11 cumplida (`config_version` 21 existe) | TODO; decide el operador |
