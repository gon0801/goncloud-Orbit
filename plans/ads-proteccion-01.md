...
| R-H5-1 | `H5/review-opus-r2.md:162-168` obs 9 | R1 obs 1 y 4-11 abiertas (pesan obs-4: conteo `applied_at` no ve bids, sumar `apply_attempt`; obs-7: digest antes/despues; obs-11 cumplida: `config_version` 21 existe) | TODO; decide el operador |
