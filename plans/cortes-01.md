...
- 事項: external-send — corrida CONTRAFACTUAL de solo lectura para el reporte de 1.5 (la maquinaria pura sobre un snapshot leído; NO escribe decisiones — a diferencia del plan v1, ya no se corre un ciclo shadow extra)
  理由: DoD de 1.5 (delta atribuible solo a la regla)
  scope: Phase 1 / 1.4
