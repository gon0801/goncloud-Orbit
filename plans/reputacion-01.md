...
Versión: 1.3, 2026-09-07. Redacción del lead (sustituye el brief
`plans/brief-reputacion-01-deepseek.md`, conservado como antecedente).
Atiende cross-review (2 majors + 4 minors). D1–D7 cerradas por el dueño (D6:
tope $10 USD/mes; recurrencia la fija 0.2 para caber en el tope).
...
| 0.5 | [stage:planificacion] [lane:gate] [tdd:skip:docs-contract] Cerrar D1–D7, API/pantalla, migración, cron y reversa | Acta E/0.5 (ratifica D1–D7; fija recurrencia Apify dentro del tope $10 USD/mes) + contrato API/pantalla/migración/cron/reversa; A.3 bloqueada hasta 0.2 | 0.1–0.4 | cc:TODO |
...
| A.3 | [stage:implementacion] [lane:gate] [tdd:required] Ingesta texto Apify (solo si 0.2 verificó y la recurrencia cabe en el tope D6; si no, cierra como ampliación con evidencia) | texto completo + dedupe por external id; costo por corrida registrado; E/A.3 | A.1,0.2,0.5 | cc:TODO |
