...
Version: 1.8, 2026-09-15 UTC. Estado: **EN IMPLEMENTACIÓN — A.0, A.1, A.2,
A.3a, A.3, A.4 y A.5 cerradas (PRs #258 `a01aed0`, #261 `b76959f`, #264
`2b136f8`, #267 `eee8152`, #269 `a3ddc7f` y #272 `f8f782d` en cola de merge;
0038 sin desplegar)**. El contrato nació en el plan v1.1 sellado el
2026-09-10; 1.2–1.4 y 1.6–1.8 registran cierres y 1.5 precisó A.3 sin
ampliar su alcance,
tras revisión
...
- **A.4 CERRADA 2026-09-14**: PR #269, HEAD `a3ddc7f`, en cola de merge (squash al final de la operación); `app/biblioteca.py`
  ...
  menores de #267 → R.1).
- **A.5 CERRADA 2026-09-15**: PR #272, HEAD `f8f782d`, en cola de merge;
  ...
  Sigue **A.6** (visibilidad y aviso); después revisión R.1 y despliegue
  (D.1 lleva 0038 a producción, D.2 limpia la terna del grupo 1 con este
  tool).
