...
- Hermanas = roles del grupo **menos `category_exact` menos el rol de origen**
  ...
  `product_targeting` solo si 0.1 lo acepta; si no, la hermana se registra en
  `external_ids["hermanas"]` como `{"skip": "pt_no_acepta_negative_keyword"}`
  (decisión 10, spec §7).
