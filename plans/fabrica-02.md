...
- **A.3a CERRADA**: PR #264, squash `2b136f8`; ejecución y reconciliación
  separadas sin cambio de comportamiento. Sigue **A.3**, la fase
  `hermanas_negadas`; después A.4 → A.5 → A.6, revisión R.1 y despliegue.
