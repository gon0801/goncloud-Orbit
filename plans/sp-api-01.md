...
- Fase A en curso: A.1 (PR #237), A.2 (PR #239), A.2b (PR #240) y A.3 (PR #241) mergeadas 2026-09-09; hotfix del GRANT de `ingest_run.llamadas` mergeado como PR #242 (migración 0034). **Deploy parcial A.6 hecho 2026-09-10 UTC**: 0031-0034 aplicadas en producción con backup, app reconstruida, primeras corridas reales de orders y pricing selladas ok (E/A.6). Siguen A.4 (Listings + Inventario, brief listo en `plans/brief-sp-api-01-a4-muse.md`), A.5 (salud y alertas), A.R (revision) y el deploy final de A.6 (migraciones de A.4/A.5 + cron).
