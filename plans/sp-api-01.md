...
- Fase A en curso: A.1 (PR #237), A.2 (PR #239), A.2b (PR #240), A.3 (PR #241), hotfix GRANT (PR #242, migración 0034) y A.4 (PR #244, migración 0035) mergeadas. **Deploy parcial A.6 hecho 2026-09-10 UTC**: 0031-0034 aplicadas en producción con backup, app reconstruida, primeras corridas reales de orders y pricing selladas ok (E/A.6). Siguen A.5 (salud y alertas — última de código de la fase), A.R (revision) y el deploy final de A.6 (migración 0035 + cron, con el SELECT de cortesía del trigger `spapi_inventario_tiempo_coherente`).
