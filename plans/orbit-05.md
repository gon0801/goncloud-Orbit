...
| 2.2 | **Spot-check del dueño sobre las primeras aplicadas** (sellado 6c): tabla en lenguaje de negocio (keyword, campaña, gasto, ventas, ACoS, acción, ack) de las primeras ≥10 decisiones aplicadas + la cola live pendiente; el dueño firma o veta. `[tdd:skip:checkpoint-humano]` | Firma del dueño en AppFlowy con fecha; vetos ejecutados por él si los hay | 1.5 | cc:WIP [2026-09-02: tabla de negocio de las 20 aplicadas (país, keyword/target, campaña, bid antes→después, %) entregada al dueño en sesión el mismo día; cola live pendiente = 0. Decisión del dueño sobre las 2 en campañas pausadas: conservar ("dejalas asi", registrada en AppFlowy y en CHAT-CONTEXT). Falta la firma explícita del dueño sobre las 18 restantes (o su veto) para cerrar] |
