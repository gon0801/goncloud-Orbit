...
- Plan v1.3 sobre el spec v1.3. Las fases 8, 10 y 11 están cerradas. **D.0 aplicada**
  en producción el 2026-09-19: migración 0039 y 20 claves `precio_*`; ningún goal,
  ninguna decisión y ningún precio movido. La forma del PATCH sigue
  `pendiente_sonda` hasta A.4.
- **Siguiente paso del dueño**: elegir y sembrar el goal `live` del producto
  controlado con `tools/precio_goal.py`, y ejecutar A.4 con el go literal. D.0 y A.1,
  sus dos prerrequisitos técnicos, ya están completos.
