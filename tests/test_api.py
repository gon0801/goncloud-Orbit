...
# app/config_write.guarda_config: fila NUEVA de config_version) y el
# descarte humano de propuestas de ADS PROTECCION C.5 (despacha a
# app/propuestas_campana.descartar_propuesta: cierra el episodio sin
# tocar Amazon).
