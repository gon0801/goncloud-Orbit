...
5. Sombra intacta tras el redeploy: 9 goals en `shadow` (0 en otro modo);
   predicados canonicos de `H5/paso5.txt:12-19` verificados hoy 2026-09-26 ~01:21 UTC:
   `apply_queue WHERE applied_at > '2026-09-25T06:13:41Z'` = 0 y
   `apply_attempt WHERE tipo='normal' AND started_at > '2026-09-25T06:13:41Z'` = 0
   (los bids no pasan por la cola; R-H5-1);
