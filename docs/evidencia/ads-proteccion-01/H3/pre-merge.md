...
- Review: 3 bot Minors abiertos (frontera estricta 3x sin caso, 2 de forma).
...
- DoD: cubierto — SHA productivo + 9 goals live en `H2/medicion.md`
  (PR #338 OPEN), test rojo->verde, readback registrado (ejecucion en
  deploy, no antes). B.2 verificado ausente de prod por md5.
- Review: cross-review opus APROBADO (ronda doc-only posterior, sin
  bloqueantes nuevos). Sin comentarios bot.
...
| 334 | 97d74388 | verde pero CONFLICTING | cubierto (peldano abstencion) | 3 Minors abiertos | NO LISTO: rebase |
| 339 | 58e9d043 | verde | cubierto | opus APROBADO | LISTO |
