...
**Corrida.** `salidas/CORRIDA.txt`: `estado: COMPLETA`, 2026-09-18T11:20:44Z a 2026-09-18T11:21:06Z UTC, `commit_del_repo: 67b37ae`, `consultas_con_cambios_sin_commitear: 0`. «Hoy» es la fecha UTC de esa corrida, **2026-09-18**. La ventana de 90 días es `[2026-09-18 − 90, 2026-09-18]` = `[2026-06-20, 2026-09-18]`. Cada tabla cita el `.sql` de `consultas/` que la produjo, y su salida literal está en `salidas/<mismo nombre>.txt`.
