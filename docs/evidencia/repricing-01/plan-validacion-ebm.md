...
| 7 | **El cargo llega tarde.** Aparece 1–11 días después de su `event_date`; el rezago por fila es p50 27 días en MX y 22 en US, p90 ~57–59, máximo 73. Una ventana de 90 días que termina hoy son ~80 días completos más una cola a medio cargar. | Diferencia entre `event_date` y la primera aparición de cada `shipping_fee` | Spec S10 «Ventana con rezago»; AC20 exige ventana efectiva |
...
| Verificación independiente, prueba de **monto exacto** | **Cero** órdenes con el mismo monto por dos fuentes distintas, en US y en MX, a 90 y a 180 días |

Consulta de la segunda:
