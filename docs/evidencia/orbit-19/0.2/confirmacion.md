...
| ID | Cierre |
|---|---|
| D1 | Orden inicial por `margen_neto_pct` maduro (porcentaje, ventana `[2026-02-20, D-15)` UTC). `dias_con_venta` visible. NULL al final, nunca 0%. MX/US no se mezclan. Por probar (Ads) **solo** con cobertura verificada; si falta el reporte: Sin datos. No prueba «nunca anunciado». |
