...
| 3.3 | Marcar `ORBIT 01` Done en AppFlowy con evidencia completa (comandos y salidas de 1.3, 1.4, 2.1, 2.2; PR ligado). Usar el nombre EXACTO existente — renombrar desde la UI desconecta la fila del script. `[tdd:skip:tracker-only]` | Fila `ORBIT 01` en Done con notas que cuentan el trabajo completo | 3.1 | cc:DONE |
